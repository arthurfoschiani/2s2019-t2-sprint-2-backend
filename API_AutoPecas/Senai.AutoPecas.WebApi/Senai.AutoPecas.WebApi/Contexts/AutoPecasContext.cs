        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Fornecedores>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Forneced__AA57D6B4232C3B16")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Forneced__448779F093DD212D")
                    .IsUnique();

                entity.HasIndex(e => e.UsuarioId)
                    .HasName("UQ__Forneced__2B3DE7B9380532FE")
                    .IsUnique();
            ...
            modelBuilder.Entity<Pecas>(entity =>
            {
                ...
                entity.HasIndex(e => e.Codigo)
                    .HasName("UQ__Pecas__06370DAC162685E6")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D1053447FCD478")
                    .IsUnique();
